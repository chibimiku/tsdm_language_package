...
$lang = array (
  ...
  'downloads' => '下载次数',
  'post_hide' => '本帖隐藏的内容',
  'post_hide_credits' => '以下内容需要积分高于 $creditsrequire 才可浏览 ($creditsrequire “积分”is needed to read the hidden content,you own $credits “积分”) (隠れた内容を読むためには、点数　$creditsrequire　以上が必要です。今手持ちの点数は　$credits　です。)',
  'post_hide_credits_hidden' => '本帖隐藏的内容需要积分高于 $creditsrequire 才可浏览，您当前积分为 {$_G[member][credits]} (If you want to read the hidden contents,you should have $creditsrequire “积分”,but you just have {$_G[member][credits]} “积分”) (もしあなたがこの隠れて内容を読みたいなら、“积分” $creditsrequire　以上が必要ですが、君が持っている“积分”は　{$_G[member][credits]}　だけです。)',
  'post_hide_reply_hidden' => '，如果您要查看本帖隐藏内容请<a href="forum.php?mod=post&action=reply&fid=$_G[fid]&tid=$_G[tid]" onclick="showWindow(\'reply\', this.href)">回复</a>(Vistor, reply to read the hidden content.) (ゲスト様、隠れた内容を読むためには、文章に返信してください。)',
  'set_cover' => '设为封面',
  'upload' => '上传',
  ...
  'modcp_posts_error_2' => '时间范围错误！版主只能删除近 4 周的帖子，超级版主可以删除 4 周内的帖子，请重新选择开始时间',
  ...
  'pay' => '购买主题(Buy the article / 文章を購入する)',
  ...
  'attach_nopermission_login' => '你需要<a href="member.php?mod=logging&action=login" onclick="showWindow(\'login\', this.href);return false;">登录</a>才可以下载或查看附件。没有帐号？<a href="member.php?mod={$_G[setting][regname]}" title="注册帐号">{$_G[setting][reglinkname]}</a>(You must sign in before downloading or check this attachment.)(添付ファイルをダウンロード、或いは見るために、まずログインしてください。)',
  'has_expired' => '该信息已经过期',
  'have' => '已有',
  'image_big' => '大图',
  ...
  'pay_comment' => '本主题需向作者支付 <strong>{$thread[price]} {$_G[setting][extcredits][$_G[setting][creditstransextra][1]][unit]}{$_G[setting][extcredits][$_G[setting][creditstransextra][1]][title]}</strong> 才能浏览 (Pay {$_G[setting][extcredits][$_G[setting][creditstransextra][1]][unit]} to read the hidden content. ) (隠れた内容を読むためには、{$_G[setting][extcredits][$_G[setting][creditstransextra][1]][unit]} ゴールドが必要です。) ',
  'pay_extip' => '【天使币 & 积分 简单获取教程】',

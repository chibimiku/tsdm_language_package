...
$lang = array (
  ...
  'attach_nopermission_login' => '您需要<a href="member.php?mod=logging&action=login">登录</a>才可以下载或查看附件。没有帐号？<a href="member.php?mod={$_G[setting][regname]}" title="注册帐号">{$_G[setting][reglinkname]}</a>(You must sign in before downloading or check this attachment.)(添付ファイルをダウンロード、或いは見るために、まずログインしてください。)',
  'attachlist' => '附件列表',
  'ban_member' => '禁止',
  ...
  'viewimg' => '查看图片',
  'download_anime' => '动漫下载页',
  'view_lightnovel' => '轻小说',
  'plugin_sign' => '签到',
  'plugin_mikusearch' => '搜索',
  'pm_announcepm' => '系统消息',
  'post_price' => '售价',
  'post_read' => '阅读权限',
  'topicadmin_show_adv_opt' => '显示高级选项',
  'topicadmin_hide_adv_opt' => '隐藏高级选项',
  'move_type_not_available' => '由于在wap下暂时没有好的ajax库，无法随选择目标版块更新分类选项，分类选项暂时不可用。',

...
$lang = array (
  ...
  'space_has_been_locked' => '空间已被锁定无法访问，请另外申请账号',
  'getpasswd_account_notmatch' => '抱歉，您填写的账户资料不匹配，不能使用取回密码功能，请另外申请账号',
  ...
  'postperm_none_nopermission' => '抱歉，您没有权限在该版块发帖。如果是新人的话，请先回几个贴子，或者上传头像就可以发主题了哦</p></div><div>',
  ...
  'credits_balance_insufficient_and_charge' => '抱歉，{title}不足 {minbalance}，请<a href="forum.php?mod=viewthread&tid=447920" target="_blank">【领钱】</a>',
  ...
  'post_subject_toolong' => '抱歉，您的标题超过 140 个字符修改标题长度',
  'post_message_tootwo' => '这年头，干什么都不容易，灌水也专业点吧。除了几个表情和标点，你不多说点什么吗？水区主题内容请在20字以上',
  ...
  'login_strike' => '密码错误次数过多，请 20 分钟后重新登录',
  ...
  'cannot_replay_threads_too_old' => '抱歉，无法回复过于古老的主题',
   'cannot_get_reward_lass_than_90_days' => '最近90天内已经申请获得密码更改奖励',
  'cp_got_reward' => '已成功获取奖励，威望+10，天使币+20，90天后再修改密码，可再次获得奖励。',
  'never_change_password' => '从未更改过密码。',
  'password_too_old_tip' => '距离上次申请，未更改新密码。',

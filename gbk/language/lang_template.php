...
$lang = array (
  ...
  'common_report' => '手机版错误报错',
  'space_view_thread' => '查看它的主题',
  'space_view_post' => '查看它的回复',
  'enter_new_tag' => '点击此处增加一个新Tag，为保障归一化效果，请只输入英文。一次只输入一个Tag。',
  'help_tag' => '什么是TAG？TAG系统使用说明',
  'vote_up_tag' => '赞同此标签',
  'vote_down_tag' => '反对此标签',
  'hide_vote_menu' => '收起标签菜单',
  'vote_succ_tag' => 'TAG投票成功',
  'vote_fail_tag' => 'TAG投票失败，可能已投票',
  'vote_neterr_tag' => 'TAG投票失败，请检查网络',
  'view_same_tag' => '查看被标记为相同TAG的主题',
  'shadow_thread_tips' => '若需在不同版发布相同内容的主题,点此查看帮助.',
  'shadow_edit' => '编辑影子主题',
  'forum_post_editcover' => '主题图片封面完整地址(214x160)',
  'mergeshadow_tip_1' => 'MasterTid，主Tid',
  'mergeshadow_tip_2' => 'Slavetid，合并的Tid，执行后这个主题的回复，会被挪到mastertid下面。',
  'yuusya_name' => '天使动漫勇者系统',
  'yuusya_tip_1' => '科学技术是第一生产力 ——邓小平',
  'yuusya_viewthread_btn' => '死亡印记',
  'yuusya_viewthread_btn_tip' => '标记这个贴子为广告',
  'tsdmask_typeid' => '类型ID',
  'tsdmask_year' => '发行年代',
  'tsdmask_month' => '发行月份',
  'tsdmask_viewday' => '星期数',
  'tsdmask_tid' => '对应tid',
  'tsdmask_name' => '动画名称',
  'ask_groupedit_keywordtip' => 'keyword使用提示：用制表符\t分隔.',
  'tsdmship_class' => '级',
  'tsdmship_type' => '舰',
  'weak_tip_top' => '弱密码提示',
  'weak_top_content_1' => '您当前密码属于弱密码，请修改密码，保持同时包含大小写字母、数字 <a style="color:#FF0000" href="home.php?mod=spacecp&ac=profile&op=password" target="_blank">点击这里修改</a><br />Your password isn\'t safe enough.Please change your password and make sure both letters and numbers are included.<br />安全のために、パスワードには数字、英大文字、英小文字が必要です。パスワードを変更してください。',
  'weak_top_content_2' => '扫号机在扫描弱密码账号用来发广告. 设置好安全问题可以避免被盗,注意：号码被盗后可能永远无法找回',
  'lang_zh' => '简体中文',
  'lang_jp' => '日本語',
  'spacecp_style_select' => '风格选择',
  'from_tsdmapp_android' => '来自天使动漫安卓APP',
  'from_tsdmapp_ios' => '来自天使动漫IOS版APP',
  'app_not_login' => '你尚未登录，需要先在app侧边栏中进行登录，再刷新页面。如果仍然遇到问题，请通过app的报错功能进行上报，标明机型和版本号。',
  'lastchange_time' => '更新密码时间:{$_G[member][lastpwdchangestr]}',
);
